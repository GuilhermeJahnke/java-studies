...
public class EntryReceiptRepository {
    ...
    public int createEntryReceipt(boolean REC_RECEIVED, String REC_RECEIVED_DATE, double REC_VALOR, String REC_DATE, String REC_CATEGORY,
        ...
        try {
            ...
            statement.setString(2, REC_RECEIVED_DATE);
            statement.setDouble(3, REC_VALOR);
            statement.setString(4, REC_DATE);
    ...
    public int editEntryReceipt(boolean REC_RECEIVED, String REC_RECEIVED_DATE, String REC_DESCRIPITION,
                                double REC_VALOR, String REC_DATE, String REC_CATEGORY) {
        int affectedRows = 0;
        PreparedStatement statement;
